...
//{
//    public class JediQuest
//    {
//        public static string cShrap(int randomNumber)
//        {

//            List<string> cSharp = new List<string>();
//            string cSharp1 =
//                "C# is not suitable for writing applications for both hosted and embedded systems. Answer with: \"true\" or \"false\".";
            // false
//            string cSharp2 = "Does the lambda expressions are included in C# 2.0. Answer with: \"true\" or \"false\".";
            // false
//            string cSharp3 =
//                "C# programmers must use the keyword \"virtual\" to allow methods to be overridden by subclasses. Answer with: \"true\" or \"false\"";
//            // true
//            string cSharp4 = "A C# namespace is different from Java package. Answer with: \"true\" or \"false\".";
//            // false
...
//            cSharp.Add(cSharp5);
//
//            return cSharp[randomNumber];
//        }

//        public static string Java(int randomNumber)
//        {
...
//            string java5 = "The elements in a TreeSet are sorted: Answer with: \"true\" or \"false\"."; // 2
//
//            java.Add(java1);
//            java.Add(java2);
//            java.Add(java3);
...
//            java.Add(java5);
//
//            return java[randomNumber];
//        }

//        public static string OOP(int randomNumber)
//        {
//            List<string> OOP = new List<string>();
//
...
//            string oop2 = "Is Polymorphism part of the principles of Object oriented programing? Answer with: \"true\" or \"false\"."; //Polymorphism
...
//            OOP.Add(oop5);
//
//            return OOP[randomNumber];
//        }

//        public static string cPlusPlus(int randomNumber)
//        {
//            List<string> cPlusPlus = new List<string>();
//
...
//
//            cPlusPlus.Add(cPlusPlus1);
//            cPlusPlus.Add(cPlusPlus2);
//            cPlusPlus.Add(cPlusPlus3);
//            cPlusPlus.Add(cPlusPlus4);
//            cPlusPlus.Add(cPlusPlus5);
//
//            return cPlusPlus[randomNumber];
//        }
//
//
//    }
